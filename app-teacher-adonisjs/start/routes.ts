...
import SectionsController from '../app/controllers/sections_controller.js'
...
router.get('/section', [SectionsController, 'show']).as('section.show')
router.get('/section/add', [SectionsController, 'create']).as('section.add')
